...
public class ChoucairLoginPage {
    public static final Target LOGIN_BUTTON = Target.the("button that shows us the form to login").located(By.xpath("//div[@class='d-none de-lg-block']//strong[contains(text(), 'Ingresar')]"));
    ...
    public  static final Target ENTER_BUTTON = Target.the("button login page").located(By.xpath("button[contains(@class, 'btn btn-primary')]"));
}
